...
<head>
    ...
    <title>All Bookings Record</title>
    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h3 class="fw-bold mb-3">All Bookings Record</h3>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a href="{{ route('admin.reservation.view-all-bookings', $booking['reservation_id']) }}"
                                                       class="btn btn-link btn-primary" data-bs-toggle="tooltip" title="View Bookings">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                    <a href="{{ route('reservations.invoice', $booking['reservation_id']) }}" 
                                                       class="btn btn-link btn-success" data-bs-toggle="tooltip" title="Download Invoice">
